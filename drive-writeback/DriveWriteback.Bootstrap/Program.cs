...
// A different fixed port than outlook-writeback's 8400, so both bootstrap tools can
// coexist in a dev environment.
const int RedirectPort = 8500;
var redirectUri = $"http://localhost:{RedirectPort}/";
const string SecretName = "graph-refresh-token";
var scopes = new[] { "Files.ReadWrite.All", "Sites.Read.All" };
